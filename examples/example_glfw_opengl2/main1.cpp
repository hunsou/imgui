...
int main(int, char**)
{
    ...
    HWND hwnd1 = glfwGetWin32Window(window);
    ...
    DWORD dwNewExStyle = WS_EX_TOPMOST | WS_EX_LAYERED | WS_EX_TOOLWINDOW;
    //dwNewExStyle &= dwExStyle;//按位与将旧扩展样式去掉  
    Sleep(1000);
    SetWindowLong(hwnd1, GWL_EXSTYLE, dwNewExStyle);//设置新的扩展样式

    SetLayeredWindowAttributes(hwnd1, RGB(255, 255, 255), NULL, LWA_COLORKEY);
