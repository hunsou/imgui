...
int main(int, char**)
{
    ...
    while (msg.message != WM_QUIT)
    {
        ...
        ImVec4 clear_color = ImGui::ColorConvertU32ToFloat4(IM_COL32(255, 255, 255,255));
        D3DCOLOR clear_color1 = D3DCOLOR_RGBA((int)(clear_color.x * 255.0f), (int)(clear_color.y * 255.0f), (int)(clear_color.z * 255.0f), (int)(clear_color.w * 255.0f));
        g_pd3dDevice->Clear(0, NULL, D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER, clear_color1, 1.0f, 0);
